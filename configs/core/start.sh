...
if [ "$role" = "ingest" ]; then
    ...
    chown -hR www-data:www-data /var/www/html/storage/logs/laravel.log || true
    ...
    chown -hR www-data:www-data /var/www/html/storage/logs/websockets.log || true
    chown -hR www-data:www-data /var/www/html/storage/logs/horizon.log || true
